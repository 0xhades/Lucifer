pub const CREATE: &str = "https://i.instagram.com/api/v1/accounts/create/";
...
pub const USERNAME_SUGGESTIONS: &str =
    "https://i.instagram.com/api/v1/accounts/username_suggestions/";
pub const EDIT_PROFILE: &str = "https://i.instagram.com/api/v1/accounts/edit_profile/";
pub const BLOKS_USERNAME_CHANGE: &str =
    "https://i.instagram.com/api/v1/bloks/apps/com.bloks.www.fxim.settings.username.change.async/";
pub const CURRENT_USER: &str = "https://i.instagram.com/api/v1/accounts/current_user/?edit=true";
